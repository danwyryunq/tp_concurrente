...
public class ConcurDerivativeTest extends TestCase {
	...
	{
		ConcurDerivative param1 = new ConcurDerivative(8);
		param1.set(5d);

		ConcurDerivative param2 = new ConcurDerivative(8);
		param2.set(5d);
	...
	public void test_differentiate()
	{
		...
		ConcurDerivative cd = new ConcurDerivative(5);
		...
		assertEquals(1d, result.get(1));
		assertEquals(1d, result.get(2));
		assertEquals(1d, result.get(3));
		assertEquals(1d, result.get(4));
		assertEquals(1d, result.get(5));
	}
